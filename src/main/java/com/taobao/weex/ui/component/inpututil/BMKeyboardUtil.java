 ...
 * the License.
 */
package com.taobao.weex.ui.component.inpututil;
...
public class BMKeyboardUtil {
    private Context mContext;
    private BMIdCardInputView mKeyboardView;
    private Keyboard mKeyboard;
    private EditText mEditText;
    private String mReturnKeyType;
    private boolean isReturn;
    private OnkeyClickListenner mListenner;

    public BMKeyboardUtil(Context context) {
        this.mContext = context;
        this.mKeyboard = new Keyboard(mContext, R.xml.idcard_keyboard);
    }

    public synchronized void attachTo(EditText editText, String returnkeyType, boolean isReturn) {
    ...
    private void showSoftKeyboard() {
        ...
        if (mKeyboardView == null) {
            if (mContext instanceof InputInter) {
                mKeyboardView = ((InputInter) mContext).getIdCardInput();
            }
        }
        if (mReturnKeyType != null) {
            mKeyboardView.setReturnType(mReturnKeyType);
        }
        ...
        mKeyboardView.setVisibility(View.VISIBLE);
        mKeyboardView.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.show_input));
    }


    private KeyboardView.OnKeyboardActionListener mOnKeyboardActionListener = new KeyboardView
...
//                }
                ...
                if (isReturn) {
                    if (mListenner != null) {
                        mListenner.onDonekeyClick(mReturnKeyType, mEditText.getText().toString());
                    }
                }
            } else {
    ...
    public void hideKeyboard() {
        ...
        mKeyboardView.setAnimation(AnimationUtils.loadAnimation(mContext, R.anim.hide_input));
        mKeyboardView.setVisibility(View.GONE);
    }


    public interface OnkeyClickListenner {
        void onDonekeyClick(String returnKeyType, String value);
    }


    public void setOnKeyClickListenner(OnkeyClickListenner listenner) {
        this.mListenner = listenner;
    }


    public OnkeyClickListenner getListenner() {
        return mListenner;
    }
}
