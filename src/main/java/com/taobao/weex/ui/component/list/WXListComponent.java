...
public class WXListComponent extends BasicListComponent<BounceRecyclerView> {
    ...
    @Deprecated
    public WXListComponent(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String
            instanceId, boolean isLazy) {
        this(instance, dom, parent, isLazy);
    }

    public WXListComponent(WXSDKInstance instance, WXDomObject node, WXVContainer parent, boolean
            lazy) {
    ...
    private boolean setRefreshOrLoading(final WXComponent child) {
        ...
        if (getHostView() == null) {
            WXLogUtils.e(TAG, "setRefreshOrLoading: HostView == null !!!!!! check list attr has " +
                    "append =tree");
            return true;
        }
