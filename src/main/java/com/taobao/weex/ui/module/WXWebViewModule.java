...
public class WXWebViewModule extends WXModule {
    ...
    @JSMethod(uiThread = true)
    public void evaluateScriptEleRef(String webRef, final String jsString, JSCallback callback) {
        WXComponent webComponent =
                WXSDKManager.getInstance()
                        .getWXRenderManager()
                        .getWXComponent(mWXSDKInstance.getInstanceId(), webRef);
        if (webComponent instanceof WXWeb) {
            final IWebView iWebView = ((WXWeb) webComponent).getWebView();
            if (iWebView != null) {
                WebView webView = ((WXWebView) iWebView).getWebView();
                if (webView != null) {
                }
     ...
     * 反射获取
     */
//    private void getDomVaule(final String jsString, WXWebView webView) {
//        try {
//            Class<?> threadClazz = Class.forName("android.webkit.WebViewClassic");
//            try {
//                Method method = threadClazz.getMethod("fromWebView", WebView.class);
//                Object object = method.invoke(null, webView.getWebView());
//                Method m = object.getClass().getMethod("getWebViewCore", null);
//                Object o = m.invoke(object);
//                Field field = o.getClass().getDeclaredField("mBrowserFrame");
//                field.setAccessible(true);
//                final Object o1 = field.get(o);
//                final Method methodString = o1.getClass().getMethod
//                        ("stringByEvaluatingJavaScriptFromString", String.class);
//                Thread.currentThread().getName();
//                new Handler().postDelayed(new Runnable() {
//                    @Override
//                    public void run() {
//                        try {
//                            methodString.invoke(o1, jsString);
