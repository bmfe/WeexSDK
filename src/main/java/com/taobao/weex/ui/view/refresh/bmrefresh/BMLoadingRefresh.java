...
public class BMLoadingRefresh extends BMBaseRefresh {
    ...
    public BMLoadingRefresh(Context context, WXComponent component) {
    ...
    public void onRefresh() {
        ...
        if (mWeakReference != null && mWeakReference.get() != null) {
            mWeakReference.get().fireEvent(Constants.Event.ONREFRESH);
        }
    }
    ...
    public void onPullingDown(float dy, int pullOutDistance, float viewHeight) {
        if (mWeakReference != null && mWeakReference.get() != null) {
            ...
            mWeakReference.get().fireEvent(Constants.Event.ONPULLING_DOWN, data);
        }
    }
}
